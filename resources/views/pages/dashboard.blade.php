            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-6 col-md-4 col-xl-2">
                        <div class="card">
                            <div class="card-body ribbon">
                                <div class="ribbon-box green counter">20</div>
                                <a href="restaurants.html" class="my_sort_cut text-muted">
                    ...
                    <div class="col-6 col-md-4 col-xl-2">
                        <div class="card">
                            <div class="card-body ribbon">
                                <div class="ribbon-box green counter">100</div>
                                <a href="salesReps.html" class="my_sort_cut text-muted">
                    ...
                    <div class="col-6 col-md-4 col-xl-2">
                        <div class="card">
                            <div class="card-body ribbon">
                                <div class="ribbon-box green counter">8</div>
                                <a href="cities.html" class="my_sort_cut text-muted">
                                    <i class="icon-map"></i>
                                    <span>المدن</span>
                                </a>
                            </div>
                    ...
                    <div class="col-6 col-md-4 col-xl-2">
                        <div class="card">
                            <div class="card-body ribbon">
                                <div class="ribbon-box green counter">60</div>
                                <a href="districts.html" class="my_sort_cut text-muted">
                    ...
                    <div class="col-6 col-md-4 col-xl-2">
                        <div class="card">
                            <div class="card-body ribbon">
                                <div class="ribbon-box green counter">6</div>
                                <a href="priceGroups.html" class="my_sort_cut text-muted">
